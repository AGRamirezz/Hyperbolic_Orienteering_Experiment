...
for iterator in range(len(order)):
	...
	df = pd.read_excel('/Users/cogmech/Documents/NRT-Hyperbolic_Search/experiment/experiment/practice_maps/practice_maps/practice_hyp_nodes/'+str(order[iterator])+'.xlsx')
	df = df.as_matrix()
	...
	df2 = pd.read_excel('/Users/cogmech/Documents/NRT-Hyperbolic_Search/experiment/experiment/practice_maps/practice_maps/practice_hyp_distances/'+str(order[iterator])+'.xlsx')
	df2 = df2.as_matrix()
